...
public class VanTaiAdapter extends ArrayAdapter<VanTai> {
    private Context context;
    private int resource;
    private List<VanTai> listVanTai;

    public VanTaiAdapter(Context context, int resource, List<VanTai> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHodel viewHodel;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activitylistvantai,parent,false);
        ...
        VanTai vt = listVanTai.get(position);
