...
import static com.example.myapplication.R.drawable.businessman;
import static com.example.myapplication.R.drawable.manager;
...
public class StudentAdapter extends ArrayAdapter<Student> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(student.getGender().equals("Nam"))
            viewHodel.imgGender.setImageResource(businessman);
        else
            viewHodel.imgGender.setImageResource(manager);
        return convertView;
    }
