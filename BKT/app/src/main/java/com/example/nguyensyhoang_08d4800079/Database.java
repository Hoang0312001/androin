...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "QL_vantai.db";
    // ten bang
    public static final String TABLE_NAME = "t_xe";
    ...
    public int updateCAR(cvantai vt) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(BKS, vt.getBienks());
        values.put(NAME, vt.getTenchuxe());
    ...
    public List<cvantai> getAll() {
        List<cvantai> list = new ArrayList<cvantai>();
    ...
    public cvantai searchById(String bks) {
        SQLiteDatabase db = this.getReadableDatabase();
