...
public class cvantai {
    ...
    public cvantai(String bienks, String tenchuxe, String hangxe, int trongtai, String hdkd) {
        this.bienks = bienks;
    ...
    public cvantai(String tenchuxe, String hangxe, int trongtai, String hdkd) {
